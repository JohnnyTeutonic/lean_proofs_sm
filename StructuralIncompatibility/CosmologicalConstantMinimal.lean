...
-/
/-- AXIOM: Cosmological constant suppression from E8 obstruction entropy.
    The algebra requires exp properties - see CosmologicalConstant.lean for details. -/
axiom cosmological_constant_from_e8
    (P : PlanckObstruction) :
    ∃ κ : ℝ, κ > 0 ∧
