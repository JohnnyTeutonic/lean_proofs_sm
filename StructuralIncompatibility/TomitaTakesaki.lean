...
/-- 
**Key Theorem**: The modular automorphism group is the UNIQUE flow satisfying
KMS at β = 1 with respect to the state φ_Ω(a) = ⟨Ω, aΩ⟩.
-/
/-- AXIOM: KMS condition implies modular flow is a group homomorphism.
    Would require full Hilbert space machinery for rigorous proof. -/
