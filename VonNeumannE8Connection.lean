...
def outer_aut_dim (G : LieAlgebraVNData) : ℕ :=
  match G.name with
  | "E₈" => 0
  | "E₇" => 0
  | "E₆" => 1
...
theorem outer_aut_dim_E8 : outer_aut_dim E8_vn = 0 := rfl
theorem outer_aut_dim_E7 : outer_aut_dim E7_vn = 0 := rfl
theorem outer_aut_dim_E6 : outer_aut_dim E6_vn = 1 := rfl
theorem outer_aut_dim_SU5 : outer_aut_dim SU5_vn = 0 := rfl
theorem outer_aut_dim_SO10 : outer_aut_dim SO10_vn = 0 := rfl
...
def is_self_dual (G : LieAlgebraVNData) : Bool :=
  match G.name with
  | "E₈" => true
  | _ => false

theorem is_self_dual_E8 : is_self_dual E8_vn = true := rfl
theorem is_self_dual_E7 : is_self_dual E7_vn = false := rfl
theorem is_self_dual_E6 : is_self_dual E6_vn = false := rfl
theorem is_self_dual_SU5 : is_self_dual SU5_vn = false := rfl
theorem is_self_dual_SO10 : is_self_dual SO10_vn = false := rfl
